...
class HomeScreen extends StatefulWidget {
  HomeScreen({Key key, this.title = 'NILA TV NETWORK'}) : super(key: key);
    ...
    listData = [
      {
        "id": 1,
        "name": "Nila TV",
        "link": "http://shinestream.in:1935/nilatvsvg/nilatvsvg/playlist.m3u8",
        'image': "nilatv-icon.png",
        "islive": true
      },
      {
        "id": 2,
        "name": "Angel TV",
        "link": "http://shinestream.in:1935/angeltv/angeltv/playlist.m3u8",
        'image': "angeltvicon.png",
        "islive": true
      },
    ];
    //});
...
//        filterBottomSheet(context);
  ...
  Color gradientStart = Colors.brown; //Change start gradient color here
  Color gradientEnd = Colors.brown; //Change end gradient color here
